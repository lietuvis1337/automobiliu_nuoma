...
public class SearchActivity extends AppCompatActivity {
    ...
    private RecyclerView automobiliai;
    private AdapterAutomobiliai mAdapter;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://rol.freecluster.eu/mobile/search.php");
        ...
        protected void onPostExecute(String result) {
            ...
            //this method will be running on UI thread
            pdLoading.dismiss();
            List<Automobiliai> data=new ArrayList<>();
            ...
            if(result.equals("no rows")) {
                ...
                try {
                    ...
                    // public Automobiliai(String id, String data, String vartotojas, String vardas, String pavarde, String asmenskodas) {
                        Automobiliai automobilis = new Automobiliai(
                    ...
                    automobiliai = (RecyclerView) findViewById(R.id.vartotojasList);
                    mAdapter = new AdapterAutomobiliai(SearchActivity.this, data);
                    automobiliai.setAdapter(mAdapter);
                    automobiliai.setLayoutManager(new LinearLayoutManager(SearchActivity.this));
